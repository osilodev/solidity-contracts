...
50% burn at the launch
Fair Launch: 21 Nov 2021
Slippage 10%
...
o  CG/CMC listings
o  Poocoin ads – post launch
o  Shill groups and AMAs on Telegram
o  Use of influencers and specific channels through
▪️  Twitter
▪️  Telegram
▪️  Reddit
▪️  Youtube
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x25964dFD2daD02CE5fC6EF727bBcC4576133D375;
...
contract Example is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x7556f8b383B072a00A58FfFb550F3d0C98c34115);
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        address payable dev = payable(0x7556f8b383B072a00A58FfFb550F3d0C98c34115);
        swapTokensForBNB(contractTokenBalance);
        uint256 contractBNB = address(this).balance;
        sendToWallet(dev,contractBNB);
    }
